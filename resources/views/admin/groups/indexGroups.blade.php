                        ...
                        <div class="overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl">
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">
                                        Добавление и редактирование списка годов
                                    </p>
                                </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    @forelse ($groups as $index => $row)
                                        <tr>
                                            <td class="h-px w-72 whitespace-nowrap">
                                                <div class="px-6 py-3">
                                                    <span
                                                        class="block text-sm font-semibold text-gray-800">{{ $index + $groups->firstItem() }}</span>
                                                </div>
                                            </td>
                                            ...
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-1.5 flex gap-2">
                                                    <a class="inline-flex items-center text-sm font-medium text-blue-600 gap-x-1 decoration-2 hover:underline focus:outline-none focus:underline"
                                                        href="{{ route('groups.edit', $row->slug) }}">
                                                        Edit
                                                    </a>
                                                    <form
                                                        onsubmit="return confirm('Вы уверены, что хотите удалить этот год?')"
                                                        method="post"
                                                        action="{{ route('groups.destroy', $row->slug) }}">
                                                        @method('DELETE')
                                                        @csrf
                                                        <button type="submit"
                            ...
                            <div
                                ...
                                {{ $groups->links('pagination::simple-tailwind') }}
                                <!--<div>
                                    <p class="text-sm text-gray-600">
