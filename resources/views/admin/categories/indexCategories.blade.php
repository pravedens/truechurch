                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">
                                        Добавление и редактирование списка спикеров
                                    </p>
                                </div>
                                    ...
                                    @forelse ($categories as $index => $row)
                                        <tr>
                                            <td class="h-px w-72 whitespace-nowrap">
                                                <div class="px-6 py-3">
                                                    <span
                                                        class="block text-sm font-semibold text-gray-800">{{ $index + $categories->firstItem() }}</span>
                                                </div>
                                            </td>
                                                ...
                                                <div class="py-3 ps-6 lg:ps-3 xl:ps-0 pe-6">
                                                    <div class="flex items-center gap-x-3">
                                                        <img class="inline-block size-[38px] rounded-full"
                                                            src="{{ asset('storage/categories/' . $row->thumbnail) }}"
                                                            alt="Avatar">
                                                    </div>
                                                </div>
                                            </td>
